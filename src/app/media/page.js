    ...
    <section className="flex flex-col items-center justify-start text-gray-600 px-4">
      ...
      <div className="flex items-center justify-center">
        <Link href="/">
          <button
            type="button"
            className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-black rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-green-200 w-62 mt-20 animate-pulse"
          >
