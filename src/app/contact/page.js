...
function Contact() {
  ...
  if (state.succeeded) {
    return <p className="text-center mt-10 text-green-600 font-bold text-2xl">Successful 🤝 we will get back to you soon!</p>;
  }
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-8 grid md:grid-cols-2 gap-10 -mt-20 relative z-10">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-3 text-gray-700">
            <li>
              📍 <strong>Address:</strong> 123 Fastener Street, Industrial Zone,
              Lagos
            </li>
            <li>
